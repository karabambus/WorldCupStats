...
namespace WorldCupStats.data.Models
{
    ...
    public partial class Match
    {
        ...
        [JsonIgnore]
        public string DisplayName => $"{HomeTeam.Country} vs {AwayTeam.Country} on {Datetime}";
    ...
    public partial class Teams
    {
        public static List<Teams> FromJson(string json) => JsonConvert.DeserializeObject<List<Teams>>(json, WorldCupStats.data.Models.Converter.Settings);
    }

    public partial class Results
    {
        public static List<Results> FromJson(string json) => JsonConvert.DeserializeObject<List<Results>>(json, WorldCupStats.data.Models.Converter.Settings);
    }

    public partial class GroupResults
    {
        public static List<GroupResults> FromJson(string json) => JsonConvert.DeserializeObject<List<GroupResults>>(json, WorldCupStats.data.Models.Converter.Settings);
    }

    public partial class Match
    {
        public static List<Match> FromJson(string json) => JsonConvert.DeserializeObject<List<Match>>(json, WorldCupStats.data.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Teams> self) => JsonConvert.SerializeObject(self, WorldCupStats.data.Models.Converter.Settings);
        public static string ToJson(this List<Results> self) => JsonConvert.SerializeObject(self, WorldCupStats.data.Models.Converter.Settings);
        public static string ToJson(this List<GroupResults> self) => JsonConvert.SerializeObject(self, WorldCupStats.data.Models.Converter.Settings);
        public static string ToJson(this List<Match> self) => JsonConvert.SerializeObject(self, WorldCupStats.data.Models.Converter.Settings);
    }
    ...
    internal class StageNameConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            throw new Exception($"Cannot unmarshal type StageName from value: '{value}'");
        }
